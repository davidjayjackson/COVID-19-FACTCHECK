...
plot(df$date,df$DRate,type="b",main="New York City Country Daily Death Rate",col="red")
```
```{r}
...
plot(df1$date,df1$DRate,type="b",main="New York StatesDaily Death Rate",col="red")
```
